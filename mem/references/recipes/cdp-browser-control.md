# recipe: cdp-browser-control — 安全站点自动化的 CDP 直连完整流程

> 本文件是 `data/unblock/cdp-browser-control-blocked.md` 召回卡的**完整操作流程**。
> 召回卡命中后才载入本文件。来源:原 `cdp-browser-control` skill(2026-06-16 并入 mem,已 deprecated)。
